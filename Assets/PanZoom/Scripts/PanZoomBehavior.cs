                ...
                if (axis.key == Axis.FORWARD)
                {
                    ...
                    else
                    {
                        ...
                        if (focusTarget != null)
                        {
                            ...
                            Vector3 potentialPosition = referenceCamera.transform.position + axis.orientation * Vector3.forward * magnitude * UnityEngine.Time.deltaTime;
        ...
        protected virtual void UpdatePosition()
        {
            if (IsPanning)
            {
                    ...
                    isInputMethodActive[InputMethod.CustomAxis])
                {
                    ...
                    translation += contribution * UnityEngine.Time.deltaTime;
                }
